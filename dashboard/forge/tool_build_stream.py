...
from dashboard.forge.debug_log import log_build_event, log_generated_code, log_sandbox
...
from dashboard.forge.tools_engine import validate_manifest, validate_tool_schema, validate_ui_files
...
async def stream_tool_build(
    *,
    ...
    cancelled_override: Callable[[], Any] | None = None,
    ...
    async def cancelled() -> bool:
        if cancelled_override is not None:
            return await cancelled_override()
