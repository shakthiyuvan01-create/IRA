...
class DashboardServer:
    ...
    def _build_app(self) -> "FastAPI":
        ...
        # Mount forge API router (tool creation, pip, skills, batch forging)
        try:
            from dashboard.forge_router import router as forge_router
            app.include_router(forge_router)
        except ImportError as exc:
            print(f"[Dashboard] Forge router not available: {exc}")
            print("[Dashboard] Forge features require the forge/ package.")
...
<p>Press <strong style="color:#dde3ed">Remote Control</strong> in IRA to get a new QR code.</p>
</div></body></html>""")
