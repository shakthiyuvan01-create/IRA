...
class BackgroundTaskManager:
    ...
    async def _heartbeat_loop(self):
        ...
        while self._running:
            try:
                from core.services.heartbeat import supervisor as hb_super
    ...
    async def _optimize_loop(self):
        ...
        while self._running:
            try:
                from core.services.self_optimize import run_cycle
                loop = asyncio.get_event_loop()
    ...
    async def _improve_loop(self):
        ...
        while self._running:
            try:
                from core.services.self_improve import run_review
                loop = asyncio.get_event_loop()
    ...
    async def _curator_loop(self):
        ...
        while self._running:
            try:
                from core.services.curator import maybe_run
                loop = asyncio.get_event_loop()
    ...
    async def trigger_heartbeat(self) -> dict:
        ...
        from core.services.heartbeat import run_tick
        loop = asyncio.get_event_loop()
